    ...
    def process_day_option(self, date, *args, **kwargs):
        ...
        for index, row in day_df.iterrows():
            ...
            if row["option_type"] == "C":
                ...
                # else:
                #     option_df.loc[index, "kelly"] = row["Delta"] - (1 - row["Delta"]) / option_df.loc[index, "pl_ratio"]
            else:
...
if __name__ == "__main__":
    def a():
        ...
        # future_contracts = SA.get_future_contracts()
        SA.update_all_contracts()
        # for index, future_contract in future_contracts.iterrows():
        #     option_df = SA.add_greek(future_contract['Contract'])
        # print(option_df)
